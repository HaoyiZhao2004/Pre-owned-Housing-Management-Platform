...
CREATE TABLE `house_types` (
  ...
  `type_name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '户型名称',
  `description` text COLLATE utf8mb4_unicode_ci COMMENT '户型描述',
...
INSERT INTO `house_types` (`id`, `type_name`, `description`, `created_at`) VALUES (1,'一室一厅','适合单身人士或小夫妻居住哦','2025-07-03 10:49:46'),(2,'两室一厅','适合三口之家','2025-07-03 10:49:46'),(3,'三室两厅','适合大家庭','2025-07-03 10:49:46'),(4,'复式','上下两层的房屋','2025-07-03 10:49:46'),(5,'公寓','现代化公寓','2025-07-03 10:49:46'),(6,'四室一厅','很爽','2025-07-03 05:12:08');
...
CREATE TABLE `houses` (
  `id` int NOT NULL AUTO_INCREMENT,
  `house_number` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '房号',
  ...
  `status` enum('available','rented') COLLATE utf8mb4_unicode_ci DEFAULT 'available',
  `description` text COLLATE utf8mb4_unicode_ci COMMENT '房屋描述',
...
CREATE TABLE `landlords` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '房东姓名',
...
CREATE TABLE `payments` (
  ...
  `payment_type` enum('rent','deposit','utilities','penalty') COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '缴费类型',
  `payment_method` enum('cash','transfer','alipay','wechat') COLLATE utf8mb4_unicode_ci DEFAULT 'cash' COMMENT '支付方式',
  `description` text COLLATE utf8mb4_unicode_ci COMMENT '备注',
  `rental_id` int NOT NULL COMMENT '租房记录ID',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `payment_status` enum('pending','paid','returned') COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
  `paid_at` datetime DEFAULT NULL,
  `contract_number` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '合同号',
  PRIMARY KEY (`id`),
...
INSERT INTO `payments` (`id`, `payment_date`, `amount`, `payment_type`, `payment_method`, `description`, `rental_id`, `created_at`, `payment_status`, `paid_at`, `contract_number`) VALUES (43,'2025-07-04',3800.00,'deposit','transfer','押金退还',22,'2025-07-03 19:39:03','returned','2025-07-04 03:39:10','HT20250704113854'),(44,'2025-07-04',3800.00,'rent','transfer','租金(租期1个月)',22,'2025-07-03 19:39:04','paid','2025-07-04 03:39:12','HT20250704113854'),(45,'2025-07-04',3800.00,'deposit','transfer','押金',23,'2025-07-03 19:39:50','paid','2025-07-04 03:40:08','HT20250704113942'),(46,'2025-07-04',11400.00,'rent','transfer','租金(租期3个月)',23,'2025-07-03 19:39:51','pending',NULL,'HT20250704113942');
...
CREATE TABLE `rentals` (
  ...
  `status` enum('active','expired','terminated') COLLATE utf8mb4_unicode_ci DEFAULT 'active' COMMENT '状态',
...
INSERT INTO `rentals` (`id`, `start_date`, `end_date`, `monthly_rent`, `deposit_paid`, `status`, `contract_number`, `house_id`, `tenant_id`, `created_at`, `returned_at`) VALUES (22,'2025-08-02','2025-09-01',3800.00,3800.00,'terminated','HT20250704113854',2,4,'2025-07-03 19:39:03','2025-07-03 19:39:19'),(23,'2025-07-10','2025-10-08',3800.00,3800.00,'active','HT20250704113942',2,3,'2025-07-03 19:39:50',NULL);
...
CREATE TABLE `tenants` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '租客姓名',
  `phone` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '联系电话',
  `email` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '邮箱',
  `id_card` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '身份证号',
  `address` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '地址',
...
INSERT INTO `users` (`id`, `username`, `email`, `password_hash`, `full_name`, `phone`, `role`, `is_active`, `created_at`, `last_login`) VALUES (1,'admin','admin@example.com','scrypt:32768:8:1$qdZmB06KP9VOHFDI$e108f20435d75a73052eb3293db4d90c61aeb8314bf54f5766b10cdfecfba38312d28bf49525aab50ca6a81f3b3786bb35c9efa36bd4127447091d15b4dbf7b7','系统管理员',NULL,'admin',1,'2025-07-03 11:24:13',NULL);
...
-- Dump completed on 2025-07-04 11:44:04
-- MySQL数据库备份文件
-- 数据库: house_rental_db
-- 备份时间: 2025-07-04 11:44:01
-- 生成工具: 房屋租赁管理系统
-- ------------------------------------------------------
